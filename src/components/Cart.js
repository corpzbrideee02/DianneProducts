...
class Cart extends Component {
    ...
    render() {
        ...
        let addedItems = this.props.items.length ?
            ...
            (
                <div className="cartContainer"><Typography variant="h4" id="label1"> You have an empty cart.</Typography></div>
            )
        return (
            <>
                <Navbar />
                <div className="homeContainer">
                    <section className="homeSection">
                        <Typography variant="h4" component="div" id="label1"> Your Orders</Typography></section>
